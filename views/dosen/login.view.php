...
{
    redirect(site_url('dosen/beranda'));
}
...
{
	$nidn = strip_tags($_POST['txt_username']);
...
<html>
<head>
<title>Dosen Panel IKAD STMIK Banjarbaru</title>
...
<body>
    <div class="login">
        ...
        ?>
                ...
                <div class="login-mail">
                    <input type="password" id="login_password" name="txt_password" placeholder="Kata sandi">
