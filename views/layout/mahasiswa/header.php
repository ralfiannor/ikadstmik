           ...
           <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="drop-men" >
                <ul class=" nav_1">
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?= $mahasiswaRow['nim'] ?><i class="caret"></i></span><img src="<?= site_url('assets/images/in.jpg') ?>"></a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?= site_url('beranda') ?>" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Beranda</span> </a>
                    </li>                   
                    <li>
                        <a href="<?= site_url('isi-kuesioner') ?>" class=" hvr-bounce-to-right"><i class="fa fa-pencil-square nav_icon "></i><span class="nav-label">Isi Kuesioner</span> </a>
                    </li>                   
                    <li>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?= site_url('ganti-sandi') ?>" class=" hvr-bounce-to-right"> <i class="fa fa-key nav_icon"></i>Ganti Kata Sandi</a></li>
                       </ul>
                    </li>
                    
                    <li>
                        <a href="<?= site_url('logout') ?>" class=" hvr-bounce-to-right"><i class="fa fa-sign-out nav_icon"></i> <span class="nav-label">Logout</span> </a>
                    </li>
                </ul>
            </div>
            </div>
