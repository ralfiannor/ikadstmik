<?php
    require_once("../class/session_dosen.php");    
    require_once("../class/dosen.php");
    $auth_user = new dosen();    
    $user_id = $_SESSION['dosen_session'];

    $stmt = $auth_user->runQuery("SELECT * FROM dosen WHERE id=:user_id");
...
<html>
<head>
<title>dosen Panel IKD STMIK Banjarbaru</title>
           ...
           <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="drop-men" >
                <ul class=" nav_1">
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret">Dosen<i class="caret"></i></span><img src="../assets/images/in.jpg"></a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="status_kuesioner.php" class=" hvr-bounce-to-right"><i class="fa fa-pencil-square nav_icon "></i><span class="nav-label">Status Pengisian</span> </a>
                    </li>                   
                    <li>
