        ...
        <nav id="side_nav">
            <ul>
                <li>
                    <a href="<?= site_url('admin/beranda') ?>"><span class="ion-speedometer"></span> <span class="nav_title">Beranda</span></a>
                </li>
                <li>
                    <a href="#">
                        <span class="label label-danger">4</span>
                        <span class="ion-clipboard"></span>
                        <span class="nav_title">Kelola Data</span>
                    </a>
                    <div class="sub_panel">
                        <div class="side_inner">
                            <h4 class="panel_heading panel_heading_first">Kelola Data Master</h4>
                            <ul>
                                <li><a href="<?= site_url('admin/kategori') ?>"><span class="side_icon ion-ios7-star-outline"></span> Data Kategori</a></li>
                                <li><a href="<?= site_url('admin/matakuliah') ?>"><span class="side_icon ion-ios7-calendar-outline"></span> Data Matakuliah</a></li>
                                <li><a href="<?= site_url('admin/beranda') ?>"><span class="side_icon ion-ios7-folder-outline"></span> Kelola Data Pengguna</a></li>
                                <li><a href="soal.php"><span class="side_icon ion-ios7-calendar-outline"></span> Data Kuesioner</a></li>
                            </ul>
                            <h4 class="panel_heading">Kelola Data Transaksi</h4>
                            <ul>
                                <li class="add_label">
                                    <a href="tasks_label.html">Matakuliah Aktif</a>
                                    <div class="ts_label">
                                        <span class="color_a"></span>
                                    </div>
                                </li>
                                <li class="add_label">
                                    <a href="tasks_label.html">Penilaian Dosen</a>
                                    <div class="ts_label">
                                        <span class="color_b"></span>
                                    </div>
                                </li>
                                <li class="add_label">
                                    <a href="tasks_label.html">Hiki kuamna </a>
                                    <div class="ts_label">
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav_title">Monitoring</span>
                    </a>
                    <div class="sub_panel">
                        <div class="side_inner">
                            <h4 class="panel_heading">Laporan</h4>
                            <ul>
                                <li><a href="newsletter_campaigns.html">Mahasiswa yang belum mengisi kuesioner</a></li>
                                <li><a href="newsletter_templates.html">Laporan IKD</a></li>
                            </ul>
                            <h4 class="panel_heading">Grafik</h4>
                            <ul>
                                <li><a href="newsletter_report.html">Hasil Penilaian IKD</a></li>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav_title">Unduhan</span>
                    </a>
                    <div class="sub_panel">
                        <div class="side_inner">
