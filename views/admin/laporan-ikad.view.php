...
<?php $laporanikad->cetak($id,$tahun_akademik,$semester,$jurusan); ?>
<div class="footer">
...
<div class="grid-form">
    <div class="grid-form1">
        <h3 id="grid-example-basic">Laporan IKAD Dosen</h3>

            <form method="get" action="<?= site_url('admin/laporan-ikad/')?>" data-toggle="validator" role="form" data-feedback='{"success": "fa-check", "error": "fa-times"}' id="formdata">
            ...
            <a href="<?= site_url('admin/laporan-ikad/') ?>" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Batal</a>
            </form>
...
$jurusan = $_GET['jurusan'];
    ...
    $query = "SELECT a.id_dosenampu as id, d.nidn, d.nama, c.kd_mk, d.status_dosen, e.jurusan, e.nama_mk, e.sks, a.tahun_akademik, a.semester, km.jawaban as ks_mhs, ks.jawaban as ks_dosen, ad.jawaban as ad_dosen 
        ...
        $laporanikad->laporan($query,$tahun_akademik,$semester);
}
else {
